    ...
    var j = function (e) {
        ...
        function La(a) {
            if (a.oFeatures.bInfo && 0 !== a.aanFeatures.i.length) {
                var b = a.oLanguage,
                    ...
                    g;
                g = 0 === f && f == h ? b.sInfoEmpty : 0 === f ? b.sInfoEmpty + " " + b.sInfoFiltered : f == h ? b.sInfo : b.sInfo + " " + b.sInfoFiltered;
                g += b.sInfoPostFix;
                g = ia(a, g);
        ...
        function R(a) {
            var b, c, d, h, f, e = a.aoColumns.length,
                j = a.oClasses;
            for (b = 0; b < e; b++) a.aoColumns[b].bSortable && i(a.aoColumns[b].nTh).removeClass(j.sSortAsc + " " + j.sSortDesc + " " + a.aoColumns[b].sSortingClass);
        ...
        this.oApi = {
            ...
            _fnCreateCookie: function (a, b, c, d, e) {
                ...
                var c = O.location.pathname.split("/"),
                    ...
                    g;
                null !== e ? (g = "function" === typeof i.parseJSON ? i.parseJSON(b) : eval("(" + b + ")"), b = e(a, g, f.toGMTString(), c.join("/") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("/") + "/";
                e = "";
                f = 9999999999999;
        ...
        full_numbers: {
            ...
            fnUpdate: function (e, o) {
                if (e.aanFeatures.p) {
                    ...
                    for (l = v; l <= k; l++) w += t !== l ? '<a tabindex="' + e.iTabIndex + '" class="' + D.sPageButton + '">' + e.fnFormatNumber(l) + "</a>" : '<a tabindex="' + e.iTabIndex + '" class="' + D.sPageButtonActive + '">' + e.fnFormatNumber(l) + "</a>";
                    l = 0;
